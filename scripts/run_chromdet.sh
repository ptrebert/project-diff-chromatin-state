...
# Submit job 2018-03-02 19:45
# qsub -l h_vmem=100G,mem_free=50G,slots_free=2,tmp_free=20G -j y -N CDPUB -S /bin/bash run_chromdet.sh
...
SEGMENTDIR="/TL/deep/fhgfs/projects/pebert/thesis/projects/statediff/chromdet/deep_pub/cmm_segment"
...
SAMPLE_LABEL="/home/pebert/work/code/mpggit/statediff/annotation/chromdet/deep_sample_labels.tsv"

cd /home/pebert/work/code/github/ChromDet/ChromDet-master/scripts

date > ${WORKDIR}/deep_pub.log
echo "" >> ${WORKDIR}/deep_pub.log
...
run_S3det_analysis.pl -d ${SEGMENTDIR} -c ${LABEL_COLLAPSE} -h F \
                    ...
                    -o cmm_states -v &>> ${WORKDIR}/deep_pub.log

echo "" >> ${WORKDIR}/deep_pub.log
date >> ${WORKDIR}/deep_pub.log

mail -s "ChromDET finished" pebert@mpi-inf.mpg.de < ${WORKDIR}/deep_pub.log
